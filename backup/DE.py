...
from utils.restricciones import (g01, g02, evaluar, aptitud)
...
class DE:
    ...
    def _init_(self, limite:str, CR:float, F:float):
        self.limite = limite
        self.CR = CR
        self.F = F
    ...
    def seleccion(self):
        ...
        for i in range(NP):
            ...
            evaluacion_hijo = evaluar(vector_hijo, g02)
...
def main():
    ...
    de = DE(limite="boundary", CR=CR, F=F)
    de.start()
